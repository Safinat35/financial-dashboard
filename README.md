...
Tesla shows highest volatility.
Microsoft has relatively stable growth.

## Live Dashboard Link
https://financial-dashboard-hqrpgvgbpvsiiqbqnqjpf5.streamlit.app/

## Assumptions & Limitations
The dashboard only analyzes historical data and does not predict future performance.
Market externalities are not considered.
